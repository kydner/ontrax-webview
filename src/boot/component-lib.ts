...
import KLabelFilter from 'src/components/ui/KLabelFilter.vue'
import KMetaOptionGroupFilter from 'src/components/ui/KMetaOptionGroupFilter.vue'
import KOptionGroupFilter from 'src/components/ui/KOptionGroupFilter.vue'
import KOptionGroup from 'src/components/ui/KOptionGroup.vue'
import KToggle from 'src/components/ui/KToggle.vue'
import KSeparator from 'src/components/ui/KSeparator.vue'
...
import KInputTax from 'src/components/ui/KInputTax.vue'
...
export default boot(async ({ app } /* { app, router, ... } */) => {
  ...
  app.component('k-label-filter', KLabelFilter)
  app.component('k-meta-option-group-filter', KMetaOptionGroupFilter)
  app.component('k-option-group-filter', KOptionGroupFilter)
  app.component('k-toggle', KToggle)
  app.component('k-separator', KSeparator)
  ...
  app.component('k-input-tax', KInputTax)
