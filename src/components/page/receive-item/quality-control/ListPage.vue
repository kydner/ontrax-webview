...
import { LocationWarehouse, TransferItem } from 'src/common/constants/meta.constant'
...
const statuses: TStatus[] = ['QC_RECEIVE', 'QC_PASSED', 'PARTIAL_PASSED']

const toWarehouseId = ref<id | undefined>()
