...
import { VendorShipmentDataRequest, VendorShipmentResponsePage } from 'src/common/model/vendor-shipment.model'
...
import ProductDataPick from './shared/ProductDataPick.vue'
import ProductDataScan from './shared/ProductDataScan.vue'
import ProductDataNew from './shared/ProductDataNew.vue'
...
const emit = defineEmits<Emits<VendorShipmentDataRequest>>()
...
const fetchSingle = async () => {
  try {
    ...
    if (repository.getOne) {
      ...
      form.value = response as VendorShipmentDataRequest
    } else {
