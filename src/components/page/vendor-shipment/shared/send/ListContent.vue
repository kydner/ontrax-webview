          ...
          <div class="tw-flex tw-flex-col tw-space-y-1 tw-basis-auto">
            ...
            <div class="tw-flex tw-items-center tw-space-x-2">
              <svg width="12" height="13" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M8.08333 0.5V2.83333M3.41667 0.5V2.83333M0.5 5.16667H11M1.66667 1.66667H9.83333C10.4777 1.66667 11 2.189 11 2.833331C11 11.6443 10.4777 12.1667 9.83333 12.1667H1.66667C1.02233 12.1667 0.5 11.6443 0.5 11V2.83333C0.5 2.189 1.02233 1.66667 1.66667 1.66667Z"
                  stroke="#FF6F4F"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
