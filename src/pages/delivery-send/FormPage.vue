<template>
  <outbond-logistic-form-page ref="operationalFormPageRef" v-model="form" :meta="metaReceiveItem">
...
import OutbondLogisticFormPage from 'src/components/lib/OutbondLogisticFormPage.vue'
